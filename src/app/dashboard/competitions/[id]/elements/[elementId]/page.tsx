            ...
            {element.fields.map((f) => {
              ...
              return (
                <div key={f.id} className="flex items-center gap-2 text-sm flex-wrap">
                  ...
                  <span className="text-gray-400 text-xs">({f.type === "ESTIMATION" ? "Kauguste hindamine" : f.type === "POINTS_SELECT" ? "Valik punktidega" : f.type === "TIME_POINTS" ? "Aeg → punktitabel" : f.type})</span>
                  {priorityLabel && (
