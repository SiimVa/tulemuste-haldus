...
export const GET = withSecurityRoute("/api/elements/[id]", handleGET)
export const PATCH = withSecurityRoute("/api/elements/[id]", handlePATCH)
export const DELETE = withSecurityRoute("/api/elements/[id]", handleDELETE)
