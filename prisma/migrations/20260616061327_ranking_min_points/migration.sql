...
INSERT INTO "new_Competition" ("createdAt", "date", "defaultCalcType", "defaultFixedRankingPoints", "defaultHigherIsBetter", "defaultHilinemineIntervalMinutes", "defaultHilinemineMaxPenalty", "defaultHilinemineMode", "defaultHilineminePenaltyPerInterval", "defaultKPMaxValue", "defaultNotPassed", "defaultPKMaxValue", "defaultPassedNotDone", "defaultVarustusPenaltyPerItem", "defaultVastutegevusPenaltyPerLife", "id", "location", "name", "organizerId", "scoringMode", "status", "updatedAt") SELECT "createdAt", "date", "defaultCalcType", "defaultFixedRankingPoints", "defaultHigherIsBetter", "defaultHilinemineIntervalMinutes", "defaultHilinemineMaxPenalty", "defaultHilinemineMode", "defaultHilineminePenaltyPerInterval", "defaultKPMaxValue", "defaultNotPassed", "defaultPKMaxValue", "defaultPassedNotDone", "defaultVarustusPenaltyPerItem", "defaultVastutegevusPenaltyPerLife", "id", "location", "name", "organizerId", "scoringMode", "status", "updatedAt" FROM "Competition";
